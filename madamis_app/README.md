...
**`dist/madamis-gm-v1.1.0+3.apk`** — main ブランチの最新 Android 向けビルド（v1.1.0+3）

`dist/madamis-gm-release.apk` は同じ内容の固定名です。

```bash
adb install -r dist/madamis-gm-v1.1.0+3.apk
```

設定画面でバージョン `1.1.0+3` と「プレイヤーシミュレーター」項目を確認してください。
